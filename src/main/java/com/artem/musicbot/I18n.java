...
public final class I18n {
    ...
    private static final Map<String, String> EN = Map.ofEntries(
            ...
            Map.entry("player.queue", "Queue"),
                Map.entry("player.queue.prev", "Prev"),
                Map.entry("player.queue.next", "Next"),
                Map.entry("player.queue.page", "Page {0}/{1}"),
    ...
    private static final Map<String, String> RU = Map.ofEntries(
            ...
            Map.entry("player.queue", "Очередь"),
                Map.entry("player.queue.prev", "Назад"),
                Map.entry("player.queue.next", "Далее"),
                Map.entry("player.queue.page", "Страница {0}/{1}"),
